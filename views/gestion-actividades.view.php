        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <?php if ($_SESSION['codigoActividad'] !== '') : ?>
                        <a href="panel.php?modulo=finalizar/finalizarActividad" title="Finalizar Actividad" class="text-left m-2 btn btn-primary">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="panel.php?modulo=gestion-actividades" method="POST">
                    <?php if ($_SESSION['codigoActividad'] == '') : ?>
...
<div class="modal fade" id="AddModalTrabajador" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="panel.php?modulo=gestion-actividades" id="ingresar_salida" method="POST">
                    <?php if ($_SESSION['codigoActividad'] == '') : ?>
                        <div class="form-group">
                            <label for="idactividad">Actividades</label>
                            <select class="form-control" id="idactividad" name="idactividad" required>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="panel.php?modulo=gestion-actividades" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="DeleteModal1" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="panel.php?modulo=gestion-actividades" id="borrar" method="POST">
